...
let fieldSearchHelpText = """
Usage: id=ID, netid=netID, fn=Firstname, ln=Lastname, em=Email, fr=From, ge=Gender, ro=Role, pr=Program, pl=Plan, ho=Hobby, la=Language, mo=Movie, te=Team
"""
